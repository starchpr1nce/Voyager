        ...
        ZStack {
            ...
            VStack {
                ...
                Spacer()
                 ...
                 Text("В нашей игре время от времени игрок будет вставать перед выбором, жизненные ситуации бывают сильно разными и поступать в каждой конкретной ситуации решать Вам и только Вам, но хотим Вас заверить КАЖДЫЙ выбор имеет свои последствия! \"Пока выбор не сделан, всё на свете возможно\" \n Никита Андреевич Стократ")
                    .gameTextStyle(.textBack)
