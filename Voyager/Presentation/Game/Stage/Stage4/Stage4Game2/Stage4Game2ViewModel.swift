...
final class Stage4Game2ViewModel: ObservableObject {
    @Published var state: Stage4GameState = .text0
    @Published var textOutput = ""
    @Published var phraseSource = Stage4InvestReference.shared.phrases[0]
    ...
    enum Stage4GameState {
        case text0, text1, text2, text3, text4, text5, text6, text7, text8, text9, text10, text11, text12, text13, game
    }
