...
struct Stage4PreviewReference: PhraseDelegate {
    ...
    private let text3 = PhraseData(
        text: "- Нет, почти безнадёжно, вообще говоря. Оказалось, что у нас в стране нет возможности продвинуться в делах духовных, если ты просто хочешь работать, а не исполнять роль подстилки начальника. Да и знания об религиях, которые мы впитывали на парах, здесь совсем не нужны, по большому счёту. ",
        type: .exFellowStudent
    )
